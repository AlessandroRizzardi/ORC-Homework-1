...
if PLOT_COM:
    ...
    if SAVE_PLOT == True:
        f.savefig('Plots/' + PLOT_PREFIX + '-COM-pos.eps', format='eps')
    ...
    if SAVE_PLOT == True:
        f.savefig('Plots/' + PLOT_PREFIX + '-COM-vel.eps', format='eps')
    ...
    if SAVE_PLOT == True:
        f.savefig('Plots/' + PLOT_PREFIX + '-COM-acc.eps', format='eps')
...
if PLOT_COP:
    ...
    if SAVE_PLOT == True:
        f.savefig('Plots/' + PLOT_PREFIX + '-COP.eps', format='eps')
...
if PLOT_FOOT_TRAJ:
    for i in range(3):
        ...
        plt.legend()
        if SAVE_PLOT == True:
            plt.savefig('Plots/' + PLOT_PREFIX + '-foot-'+str(i+1)+'.eps', format='eps')
