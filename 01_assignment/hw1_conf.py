...
# You can set here the question number and the parameters will be adjusted
# accordingly 
question = 4
...
if question == 2:   # QUESTION 2
    ...
    w_foot          = 200                    
    w_posture       = 0.1                 
    w_squat         = 1e6       # Default: 1e6; Try: 1e3  
    kp_squat        = 1e1       # Default: 1e1; Try: 1e3
    kp_com          = 10.0                 
...
if question == 4:   # QUESTION 4
    ...
    w_posture       = 1                             
    kp_com          = 10.0              
    w_squat         = 1e5       # Default: 1e5; Try: 1e4       
    kp_squat        = 1e1       # Default: 1e1; Try: 1e2

    push_robot_com_vel = [0, 0, -0.5] 
...
# ----------------------------------------------
viewer = pin.visualize.GepettoVisualizer # pin.visualize.MeshcatVisualizer
